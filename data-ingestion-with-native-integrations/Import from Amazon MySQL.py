...
database_host = "<+++++++++++++>.us-east-1.rds.amazonaws.com" # endpoint from aws
database_port = "3306" 
...
# MAGIC %md ##### Use database name databrickstb

# COMMAND ----------

# MAGIC %sql
# MAGIC use databrickstb;

# COMMAND ----------

target_table_name = "databrickstb.candidateSkills"
...
# MAGIC %sql
# MAGIC SELECT * FROM databrickstb.candidateSkills
# MAGIC WHERE Skill like 'Python'
