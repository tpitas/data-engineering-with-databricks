...
# MAGIC -  https://www.advancinganalytics.co.uk/blog/2021/9/27/slowly-changing-dimensions-scd-type-2-with-delta-and-databricks#introduction
...
def porcess_books():
    ...
    query = (spark.readStream
                 ...
                 .writeStream
                    ...
                    .option("checkpointLocation", "dbfs:/mnt/demo_book061624/checkpoints/orders_silver")
